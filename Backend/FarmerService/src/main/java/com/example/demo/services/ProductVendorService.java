...
public class ProductVendorService {
	...
	public List<ProductVendor> getbyvid(Vendor vendor)
	{
	    return pvrepo.findByVendor(vendor);
	}

	public List<ProductVendor> getbyprodid(Product product)
	{
	    return pvrepo.findByProduct(product);
	}

	
	public Optional<ProductVendor> getById(int id) {
